...
import DuyetNghiPhep from './component/DuyetNghiPhep'
import LichSuDuyetNghiPhep from './component/LichSuDuyetNghiPhep'
import { api } from '../../../commons/api/Api';

class DuyetNghiPhepScreen extends BaseComponent {
    constructor(props) {
        super(props)
        this.state = {
        }
...
export default connect(mapStateToProps, mapDispatchToProps)(DuyetNghiPhepScreen)