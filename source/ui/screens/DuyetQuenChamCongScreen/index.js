...
import DuyetQuenChamCong from './component/DuyetQuenChamCong'
import HistoryQuenChamCong from './component/HistoryQuenChamCong'

class DuyetQuenChamCongScreen extends BaseComponent {
    constructor(props) {
        super(props)
        this.state = {
        }
    ...
    render() {
        return (
            <BaseView stylesView={{ flex: 1, backgroundColor: 'white' }}
                titleScreen={"Duyệt quên chấm công"}
            ...
            >
                ...
                >
                    ...
                    <DuyetQuenChamCong
                        navigation={this.props.navigation} tabLabel='Duyệt' />
                    <HistoryQuenChamCong
...
export default connect(mapStateToProps, mapDispatchToProps)(DuyetQuenChamCongScreen)