...
class CollapsingToolbar extends Component {
    ...
    render() {
        const { children, ViewContent, ViewTitle, leftItem, leftItemPress, rightItem, rightItemPress, title, titleColor, toolbarColor, toolbarMaxHeight, toolbarMinHeight } = this.props;
